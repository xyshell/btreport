...
class PerformanceReport:
    ...
    def __init__(self, stratbt, outputdir,
    ...
    def plot_return_curve(self, fname='return_curve.png'):
        ...
        _ = returns.plot.bar(color=is_positive.map(
            {True: 'green', False: 'red'}), ax=ax)
        return fig
    ...
    def generate_html(self):
        ...
        template = env.get_template('btreport/templates/template.html')
